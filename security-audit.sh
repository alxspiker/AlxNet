...
# Comprehensive Security Audit Script for Betanet
...
{
    echo "# Betanet Security Audit Report"
    echo "Generated: $(date)"
    echo "Version: $(git describe --tags --always 2>/dev/null || echo 'unknown')"
    echo ""
    echo "## Executive Summary"
    echo ""
    echo "This report details the security posture of the Betanet decentralized web platform."
...
# Add summary to report
{
    ...
    echo ""
    echo "---"
    echo "*Report generated by Betanet Security Audit Script*"
} >> "$REPORT_FILE"

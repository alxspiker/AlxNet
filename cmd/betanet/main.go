...
func usage() {
	fmt.Println("Betanet - Complete Decentralized Web Platform")
	fmt.Println("")
	fmt.Println("Commands:")
	fmt.Println("  start    Start the complete Betanet platform")
	...
	fmt.Println("  betanet start                                    # Start with all defaults")
	fmt.Println("  betanet start -node-port 4001                   # Specify P2P port")
	fmt.Println("  betanet start -browser-port 8080 -wallet-port 8081")
	fmt.Println("")
...
func cmdStart() {
	...
	fmt.Println("")
	fmt.Println("🚀 Betanet Platform is running!")
	fmt.Println("=====================================")
	...
	logger.Info("Shutting down Betanet Platform...")
